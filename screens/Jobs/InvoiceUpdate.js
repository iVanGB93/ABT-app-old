...
import { updateInvoice } from "../../store/actions/jobsActions.js";

export default function InvoiceUpdate({navigation}) {
    ...
    const handleSubmit = () => {
        if (Object.keys(charges).length !== 0) {
            dispatch(updateInvoice(job.id, price, paid, charges));
        } else {
